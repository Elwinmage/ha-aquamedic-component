...
Controle sus bombas de movimiento Aqua Medic desde Home Assistant a través de la API cloud de Gizwits.
...
| Dispositivo | Nombre interno | Clave de producto | Compatible |
|---|---|---|---|
...
Todos estos dispositivos utilizan la plataforma IoT Gizwits (mismo backend que la aplicación oficial de Aqua Medic). La compatibilidad con dispositivos adicionales podrá añadirse en futuras versiones.

---

## Entidades

Cada dispositivo SmartDrift / EcoDrift expone las siguientes entidades en Home Assistant.
...
| **Modo control 0-10V** | Cuando está activo, desactiva el control de caudal (la bomba es controlada por señal externa 0-10V) |
...
| Entidad | Descripción |
|---|---|
| **Actualizar** | Fuerza una actualización inmediata sin esperar al siguiente ciclo de sondeo |
...
| Campo | Descripción |
|---|---|
| **E-mail** | Dirección de correo de su cuenta Aqua Medic |
| **Contraseña** | Contraseña de su cuenta Aqua Medic |
| **Servidor Gizwits** | Servidor regional — seleccionar **Europa** para usuarios de la UE |
| **Intervalo de actualización** | Frecuencia de sondeo del dispositivo (5–300 s, predeterminado 30 s) |

El servidor correcto se preselecciona automáticamente según el idioma de Home Assistant.

Tras la configuración, el intervalo de actualización puede modificarse en **Configuración → Dispositivos y servicios → Aqua Medic → Configurar**.
